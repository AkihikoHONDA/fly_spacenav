"""Procedural mascot B and illustrative foreleg IK; the Phase 4A command stays exact."""
import json
...
ASSETS=Path('assets/fly_pilot_phase4b')
PARAMS=settings()
...
def load_asset():
 ...
 assert m['default']=='B' and not m['external_assets']
