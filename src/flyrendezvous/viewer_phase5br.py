...
assert CONDITION == "H0"
OUT=Path("outputs/phase5br/demo")/CONDITION
OUT.mkdir(parents=True,exist_ok=True)
SOURCE=Path("outputs/phase5br")
load_config=lambda:json.loads(Path("configs/phase5br/training.json").read_text())
...
def build(mode,allow_missing=False):
    ...
    testlock=json.loads((SOURCE/"fresh_test.json").read_text())
    ...
    rr.init("FlyRendezvous-Phase5BR-"+CONDITION+"-"+mode,spawn=False,strict=True)
