...
def build(mode,allow_missing=False):
    ...
    multi=True
    from .pilot_phase4b import PILOT_EYE,PILOT_LOOK,PILOT_UP,reset as pilot_reset,load_asset,log_static as pilot_static,log_sample as pilot_sample
    ...
    rr.init("FlyRendezvous-Phase4B-"+mode,spawn=False,strict=True)
