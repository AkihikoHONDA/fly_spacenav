...
OUT=Path('docs/evidence_phase4b')
...
for i,name in enumerate('ABC'):
 ...
 canvas.paste(image,(i*480,30));draw.text((i*480+15,10),'Variant '+name+(' (default)' if name=='B' else ''),fill='white')
canvas.save(OUT/'design_comparison.png')
rect=(1325,945,1830,1370)
sources=[('Phase 4A | fixed external fly','docs/evidence_phase4a/demo_early.png'),('Phase 4B | procedural B + IK','docs/evidence_phase4b/demo_early.png')]
width=rect[2]-rect[0];height=rect[3]-rect[1]
canvas=Image.new('RGB',(2*width,height+32),(22,27,35));draw=ImageDraw.Draw(canvas)
meta=[]
...
dest=OUT/'phase4a_vs_phase4b.png';canvas.save(dest)
