...
def main():
    ...
    os.chdir(ROOT);condition=os.environ["PHASE5B_CONDITION"];out=ROOT/"outputs/phase5b/demo"/condition;evidence=ROOT/"docs/evidence_phase5b"/condition;evidence.mkdir(parents=True,exist_ok=True)
