...
def main():
    ...
    os.chdir(ROOT);out=ROOT/"outputs/phase4b";evidence=ROOT/"docs/evidence_phase4b";evidence.mkdir(parents=True,exist_ok=True)
    ...
    try:
        ...
        screenshots=[]
        for label,k in zip(["neutral","early","diagonal","braking","hold"],indices):
