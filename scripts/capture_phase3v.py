...
def main():
    ...
    os.chdir(ROOT);out=ROOT/"outputs/phase3v";evidence=ROOT/"docs/evidence_phase3v";evidence.mkdir(parents=True,exist_ok=True)
    source_dir=ROOT/"outputs/phase3" if args.baseline else out
    prefix="baseline" if args.baseline else args.mode
    rrd=source_dir/(("phase3_" if args.baseline else "phase3v_")+args.mode+".rrd")
